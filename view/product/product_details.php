        ...
        <div class="er_comment">
            ...
            ?>
                <form action="index.php?btn=add_bl" method="post">
                    <p class="notification_order" style="margin: 0; text-align: left;">
                        <?php

                        if (isset($thong_bao_bl)) {
                            echo $thong_bao_bl;
                        } ?>
                    </p>
                    ...
                    <div class="items_comment">
                        ...
                        <div class="er_signin_success">
                            ...
                            <i class="fa-solid fa-paper-plane icon_send"></i>
                        </div>
                    </div>
                    <input type="hidden" name="ma_sp" value="<?= $one_sp['ma_sp'] ?>">
            ...
            foreach ($sp_dm as $sp) {
                ...
                echo '<div class="items-product">
                        ...
                        <div class="text">
                            ...
                            <a class="view" href="#"><i class="fa-solid fa-eye"> View</i></a>
                        </div>';
            }
            ?>
        </div>
