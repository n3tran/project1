    ...
    <div class="page_sign_up">
        <div class="sign_up">
            ...
            <form action="index.php?btn=update_user" method="post" class="form_sign_up">
                ...
                <div class="items_sign_up">
                    <div class="input-group">
                        <input required="" type="text" name="address" autocomplete="off" class="input-items" style="width: 490px; margin-top: 0;" value="<?= $dia_chi ?>">
                        <label class="user-label">Địa Chỉ</label>
                        <!-- <p class="error">Email của bạn nhập không đúng &#9888 </p> -->
                    </div>
                    <div class="input-group ">
                        <p >Vai trò</p>
                        <input type="number" name="vai_tro" class="role" value="<?= $vai_tro ?>">
                        <?php
                         if(isset($errors)){
                            echo $errors;
                        }
