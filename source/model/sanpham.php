...
if (!function_exists('giaSp_tangdan')) {

    function giaSp_tangdan()
    {
        $sql = "SELECT * FROM `san_pham` 
        order by `san_pham`.`gia_sp` asc;";
        $sanpham = pdo_query($sql);
        return $sanpham;
    }
}
if (!function_exists('giaSp_giamdan')) {

    function giaSp_giamdan()
    {
        $sql = "SELECT * FROM `san_pham` 
        order by `san_pham`.`gia_sp` desc;";
        $sanpham = pdo_query($sql);
        return $sanpham;
    }
}
