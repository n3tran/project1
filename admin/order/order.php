    ...
    <div class="content">
        ...
        foreach ($donhang as $list) {
            ...
            <div class="content-product">
                ...
                <div style="width: 10%;" class="product-items">
                    <?php if (isset($list['ma_order'])) {
                        ?>
                        <a href="index.php?btn=xoa_dh&id=<?= $list['ma_order'] ?>" onclick="return confirm('Bạn có thực sụ muốn xóa đơn hàng') " ><input type="submit" name="add_new"
        ...
        <?php if (isset($list['ma_order'])) {
            ...
            <div class="" style="margin-left: 60px; margin-bottom: 20px;">
                <a href="index.php?btn=trangthai_dh"><input type="submit" name="add_new" value="Cập nhật đơn hàng"
                        class="btn_submit" style="border: none;"></a>
            </div>
            <?php
        } ?>
</main>
